...
/** @type {string} */
const CACHE_VERSION = '1782981350|2709212097';
/** @type {string} */
const CACHE_PREFIX = 'First gameeeee-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'sasta.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["sasta.html","sasta.js","sasta.offline.html","sasta.icon.png","sasta.apple-touch-icon.png","sasta.audio.worklet.js","sasta.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["sasta.wasm","sasta.pck"];
